...
export default function BidsHistoryPage() {
  ...
  useEffect(() => {
    async function loadProposals() {
      try {
        const { proposals: data } = await getContractorProposals();
        
        // Sort by last_viewed_at descending (nulls last), then updated_at descending
        ...
        console.error("[BidsHistory] Failed to load proposals:", e);
      } finally {
        setLoading(false);
      }
    }
