...
export default function AuthResetPasswordPage() {
  ...
  // Establish the password-recovery session from the email/SMS link. The
  // browser client (PKCE + detectSessionInUrl) auto-exchanges the `?code=`
  // param on load and fires PASSWORD_RECOVERY, so we listen for that and also
  // fall back to getSession() in case the event already fired.
  useEffect(() => {
